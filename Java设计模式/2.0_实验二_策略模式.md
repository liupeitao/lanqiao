...
![策略模式的 UML 图](./images/strategy_pattern_uml_diagram.jpg)
...
![image-20221018202710284](./images/image-20221018202710284.png)
...
interface IPayStrategy{
    public Boolean pay(int money);
    public BigDecimal queryBanlance();
}
...
class AliPayStrategy implements IPayStrategy{
    ...
    @Override
    public BigDecimal queryBanlance() {
       System.out.println("Alipy Banlance is 20") ; 
       return new BigDecimal(20);
    }
}
...
class WeChatPayStrategy implements IPayStrategy{
    ...
    @Override
    public BigDecimal queryBanlance() {
       System.out.println("WeChatPay Banlance is 290") ; 
       return new BigDecimal(290);
    }
}

class Context implements IPayStrategy{
    ...
    @Override
    public Boolean pay(int money) {
        return strategy.pay(money);
    }
    @Override
    public BigDecimal queryBanlance() {
        return strategy.queryBanlance();
    }
}
public class StrategyTest {
    public static void main(String[] args) {
        Context context1 = new Context(new WeChatPayStrategy());
        Context context2 = new Context(new AliPayStrategy());
        context1.pay(200);
        context2.pay(19);
        context1.queryBanlance();
        context2.queryBanlance();
    }
}
```
