...
![05](4.3_对一列的修改(即对表结构的修改).assets/sql-05-05.png)
...
![06](4.3_对一列的修改(即对表结构的修改).assets/sql-05-06.png)
...
![07](4.3_对一列的修改(即对表结构的修改).assets/sql-05-07.png)
...
![08](4.3_对一列的修改(即对表结构的修改).assets/sql-05-08.png)
...
![09](4.3_对一列的修改(即对表结构的修改).assets/sql-05-09.png)
